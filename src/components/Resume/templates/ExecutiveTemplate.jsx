// ============================================================
// The ROI Executive — Financial & Growth Focus
// ============================================================
...
export default function ROIExecutiveTemplate({ 
  data, 
  category = CATEGORIES.CHRONOLOGICAL, 
  accentColor: propAccentColor = '#0f172a', 
  ...
  const accentColor = propAccentColor || '#0f172a';
  ...
  const bodyStyle = { fontSize: config.textSize, lineHeight: config.lineHeight, color: '#1e293b', fontFamily: isAr ? 'var(--global-font)' : '"Tahoma", sans-serif' };
  const headingStyle = { 
    color: accentColor, 
